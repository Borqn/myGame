...
function Player:move(dt) -- moves the player in response to the user input
    ...
    function Player:checkBoundaries() -- checks for collisions with the boundaries of the window and stops when neccesary
        if self.y < 0 then
            self.y = 0
